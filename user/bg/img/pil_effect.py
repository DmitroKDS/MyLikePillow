...
def add(image: Image.Image) -> Image.Image:
    """
    ...
    expand_image = Image.new("RGBA", canvas_size, (238, 255, 255, 0))
    ...
    result = add_inner_shadow(result)

    return result


def add_inner_shadow(image: Image.Image) -> Image.Image:
    """
